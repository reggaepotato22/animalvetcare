...
interface PostMortemReportDialogProps {
...
export function PostMortemReportDialog({ children, patientData }: PostMortemReportDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Post Mortem Examination Report</DialogTitle>
        </DialogHeader>
            ...
            {patientData && (
              <div className="p-4 bg-muted rounded-lg">
                ...
                <div className="grid grid-cols-3 gap-2 text-sm">
                  <div>Name: <span className="font-medium">{patientData.name}</span></div>
                  <div>Species: <span className="font-medium">{patientData.species}</span></div>
                  <div>Breed: <span className="font-medium">{patientData.breed}</span></div>
                </div>
              </div>
            )}
